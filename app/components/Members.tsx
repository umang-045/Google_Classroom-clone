...
import { classphoto } from '../dashboard/allclasses/page'
import { AVATAR_COLORS } from './ClassroomCard'


interface MemberProp {
  classroomDetails: classroomProp
}

const Members = ({ classroomDetails }: MemberProp) => {
    return (
